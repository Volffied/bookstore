    ...
    return (
        <Layout title={"Blog"}>
            <div className='flex flex-wrap mt-6 mb-24'>
                <p className={styleFont.custom_font_bold + ' text-7xl'}>Blog</p>
            </div>
            ...
            <HeaderMenus>
                <Link href={"/blog"} className={(router.pathname == "/blog" ? "underline decoration-wavy text-secondary border-secondary":"hover:underline hover:decoration-secondary decoration-wavy") + " py-1 underline-offset-4 text-base transition-all ease-in-out duration-500 text-center"}>
                    <p className={styleFont.custom_font_light + " text-xl"}>View All</p>
                </Link>
                <Link href={"/fashion"} className={(router.pathname == "/fashion" ? "underline decoration-wavy text-secondary border-secondary":"hover:underline hover:decoration-secondary decoration-wavy") + " py-1 underline-offset-4 text-base transition-all ease-in-out duration-500 text-center"}>
                    <p className={styleFont.custom_font_light + " text-xl"}>Fashion</p>
                </Link>
                <Link href={"/culture"} className={(router.pathname == "/culture" ? "underline decoration-wavy text-secondary border-secondary":"hover:underline hover:decoration-secondary decoration-wavy") + " py-1 underline-offset-4 text-base transition-all ease-in-out duration-500 text-center"}>
                    <p className={styleFont.custom_font_light + " text-xl"}>Culture</p>
                </Link>
                ...
                <Link href={"/opinion"} className={(router.pathname == "/opinion" ? "underline decoration-wavy text-secondary border-secondary":"hover:underline hover:decoration-secondary decoration-wavy") + " py-1 underline-offset-4 text-base transition-all ease-in-out duration-500 text-center"}>
                    <p className={styleFont.custom_font_light + " text-xl"}>Opinion</p>
                </Link>
